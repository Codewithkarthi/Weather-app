  ...
  fetch(url)
    ...
    .then((data) => {
      ...
      if (weatherMain == "Clear") {
        image.src = "https://i.ibb.co/HHjDpLM/Kashmir-4-999x800.jpg";

        myWeatherContainer.style.backgroundColor = "#ec6e4c";
      }

      if (weatherMain == "Clouds") {
        image.src = "https://i.ibb.co/r2zSXSZ/sky-background.jpg";

        myWeatherContainer.style.backgroundColor = "#86d3d3";
      }

      if (weatherMain == "Rain") {
        image.src = "https://i.ibb.co/fYxk9CK/rain-main-min.jpg";
      ...
      if (weatherMain == "Drizzle") {
        image.src =
          "https://i.ibb.co/5MyF2b9/HD-wallpaper-flowers-in-the-rain-nature-sunflower-drizzle-raindrops.jpg";

        myWeatherContainer.style.backgroundColor = "#8ecfcf";
      }

      if (weatherMain == "Haze") {
        image.src = "https://i.ibb.co/W3BHYGJ/649b4a7261c6f-image.jpg";

        myWeatherContainer.style.backgroundColor = "#d8ced2";
      }
    if (weatherMain == "Mist") {

        image.src = "https://i.ibb.co/wgnYn4H/dark-mist-trees-forest.jpg" 

        myWeatherContainer.style.backgroundColor = "#E389B9";

      }
    if (weatherMain == "Smoke") {

        image.src = "https://i.ibb.co/ZSXtTC2/123744381-gettyimages-1234239131.jpg"

        myWeatherContainer.style.backgroundColor = "#11C7AA";
